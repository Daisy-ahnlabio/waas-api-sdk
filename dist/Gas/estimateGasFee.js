...
var estimateGasFee = function (accessToken, network, isEIP1559, params) { return __awaiter(void 0, void 0, void 0, function () {
    var endpoint, response, gasFee, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL).concat(endpoint), {
                        network: network,
                        to: params.to,
                        from: params.from,
            ...
            case 1:
                ...
                if (response.status === 200) {
                    gasFee = response.data.result;
                    console.log(chalk_1.default.green("Estimated gas fee: "), chalk_1.default.blue(gasFee));
                    return [2 /*return*/, gasFee];
                }
                else {
...
exports.default = estimateGasFee;
//# sourceMappingURL=estimateGasFee.js.map