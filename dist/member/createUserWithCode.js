...
function createUserWithCode(username, password, code, overage, agree, collect, thirdparty, advertise) {
    return __awaiter(this, void 0, void 0, function () {
        var channelid, encryptedPassword, data, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/member/user-management/users/v2/adduser"), data, {
                            headers: {
                ...
                case 4:
                    ...
                    if (axios_1.default.isAxiosError(error_1)) {
                        ...
                        console.error(chalk_1.default.red("Error: ".concat(error_1.message)), chalk_1.default.red("An unknown error occurred."));
...
exports.default = createUserWithCode;
//# sourceMappingURL=createUserWithCode.js.map