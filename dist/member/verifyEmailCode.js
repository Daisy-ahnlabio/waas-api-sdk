...
var verifyEmailCode = function (email, code) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/member/mail-service/").concat(email, "/verifycode"), qs_1.default.stringify({
                        email: email,
                        code: code,
