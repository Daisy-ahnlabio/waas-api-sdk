...
var sendVerificationCode = function (email, lang, template) {
    if (lang === void 0) { lang = "en"; }
    if (template === void 0) { template = "verify"; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("".concat(process.env.REACT_APP_WAASURL, "/member/mail-service/").concat(email, "/sendcode"), {
