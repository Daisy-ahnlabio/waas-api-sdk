...
var checkUserAvailability = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.REACT_APP_WAASURL, "/member/user-management/users/").concat(email), {
                        params: { serviceid: process.env.REACT_APP_SERVICE_ID },
                    })];
            case 1:
                response = _a.sent();
                if (response.status === 200) {
                    console.log(chalk_1.default.green("User can sign up."));
                }
                else {
                    console.error(chalk_1.default.red("Failed. HTTP Status: ".concat(response.status)));
                    throw new Error("Failed. HTTP Status: ".concat(response.status));
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                if (error_1.response) {
                    ...
                    throw new Error(error_1.response.data.msg || error_1.message);
                }
...
exports.default = checkUserAvailability;
//# sourceMappingURL=checkUserAvailability.js.map