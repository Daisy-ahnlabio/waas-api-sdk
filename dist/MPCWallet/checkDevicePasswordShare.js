...
var checkDevicePasswordShare = function (accessToken, devicePassword, pvencstr) { return __awaiter(void 0, void 0, void 0, function () {
    var channelid, encryptedData, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, AuthUtil_1.encrypt)(devicePassword)];
            case 2:
                encryptedData = _a.sent();
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/mpc/wallets/check/device-password/share"), qs_1.default.stringify({
            ...
            case 3:
                ...
                if (response.status === 200) {
                    console.log(chalk_1.default.green("Check Device Password Share Response:"), chalk_1.default.blue(response.data));
...
exports.default = checkDevicePasswordShare;
//# sourceMappingURL=checkDevicePasswordShare.js.map