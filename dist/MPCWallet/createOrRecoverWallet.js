...
var createOrRecoverWallet = function (accessToken, email, password) { return __awaiter(void 0, void 0, void 0, function () {
    var channelid, encryptedPassword, response, responseData, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/mpc/wallets"), qs_1.default.stringify({
                        email: email,
...
//# sourceMappingURL=createOrRecoverWallet.js.map