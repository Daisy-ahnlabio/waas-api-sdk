...
var getWalletBalance = function (accessToken, network, address) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/aptos/balance"), {
                        headers: {
            ...
            case 1:
                ...
                if (response.status === 200) {
                    ...
                    console.log(chalk_1.default.green("Successfully retrieved wallet balance for address:"), chalk_1.default.blue(address));
                    console.log(chalk_1.default.green("Network:"), chalk_1.default.blue(network));
                    console.log(chalk_1.default.green("Wallet Balance:"), chalk_1.default.blue(balance));
