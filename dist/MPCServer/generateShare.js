...
var generateShare = function (accessToken, password) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_MPC, "/v1/generateShare"), {
            ...
            case 1:
                ...
                if (response.status === 200) {
                    data = response.data;
                    console.log(chalk_1.default.green("Key share generated successfully:"), chalk_1.default.blue(JSON.stringify(data, null, 2)));
...
exports.default = generateShare;
//# sourceMappingURL=generateShare.js.map