...
var signMessage = function (hash, encryptedPassword, mpcToken, pvencStr, sid, uid, wid) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_MPC, "/v1/sign"), requestData, {
                        headers: {
            ...
            case 1:
                ...
                if (response.status === 200) {
                    console.log(chalk_1.default.green("Message signed successfully:"), chalk_1.default.blue(JSON.stringify(response.data, null, 2)));
...
//# sourceMappingURL=mpcServerSign.js.map