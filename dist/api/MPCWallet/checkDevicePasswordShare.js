...
const checkDevicePasswordShare = (accessToken, devicePassword, pvencstr) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { channelid } = yield (0, AuthUtil_1.getSecureChannel)();
        const encryptedData = yield (0, AuthUtil_1.encrypt)(devicePassword);
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/mpc/wallets/check/device-password/share`, qs_1.default.stringify({
