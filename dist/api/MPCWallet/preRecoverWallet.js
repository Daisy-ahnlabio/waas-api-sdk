...
const preRecoverWallet = (accessToken) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.get(`${process.env.REACT_APP_WAASURL}/wapi/v2/mpc/wallets/recover`, {
            headers: {
