...
const recoverWallet = (accessToken, ucpubkey, uid, wid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/mpc/wallets/recover`, qs_1.default.stringify({
            ucpubkey: ucpubkey,
            uid: uid,
            wid: wid,
        }), {
