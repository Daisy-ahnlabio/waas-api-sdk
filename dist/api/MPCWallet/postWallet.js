...
const postWallet = (accessToken, email, ourpubkey, ucpubkey, uid, wid, sid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/mpc/wallets/post`, qs_1.default.stringify({
            email: email,
            address: sid,
            ourpubkey: ourpubkey,
            ucpubkey: ucpubkey,
