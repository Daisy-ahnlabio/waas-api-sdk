...
const signMessage = (hash, encryptedPassword, mpcToken, pvencStr, sid, uid, wid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const requestData = {
        ...
        const response = yield axios_1.default.post(`${process.env.REACT_APP_MPC}/v1/sign`, requestData, {
            headers: {
