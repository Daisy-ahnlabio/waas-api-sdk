...
const generateShare = (accessToken, password) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_MPC}/v1/generateShare`, {
