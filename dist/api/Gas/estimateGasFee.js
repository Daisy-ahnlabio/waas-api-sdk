...
const estimateGasFee = (accessToken, network, isEIP1559, params) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const endpoint = isEIP1559
            ? "/wapi/v2/gas/estimate/eip1559"
            : "/wapi/v2/gas/estimate/legacy";
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}${endpoint}`, {
            network,
            to: params.to,
            from: params.from,
