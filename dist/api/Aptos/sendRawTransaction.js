...
const sendRawTransaction = (accessToken, network, sender, receiver, amount, expirationTimestampSecs, sequenceNumber, maxGasAmount, gasUnitPrice, pubkey, signatureJson) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/aptos/transfer`, {
            sender,
            receiver,
            amount,
