...
const getNfts = (accessToken, network, walletAddress, minimalInfo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.get(`${process.env.REACT_APP_WALLETSCAN}/nfts`, {
            headers: {
