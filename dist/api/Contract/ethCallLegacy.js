...
const ethCallLegacy = (accessToken, network, toAddress, data, fromAddress, gasLimit, gasPrice, value, nonce) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/contract/eth-call/legacy`, new URLSearchParams({
            network,
            from: fromAddress,
            to: toAddress,
            gasLimit,
