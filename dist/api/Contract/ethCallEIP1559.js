...
const ethCallEIP1559 = (accessToken, network, toAddress, data, fromAddress, gasLimit, value, nonce, maxPriorityFeePerGas, maxFeePerGas) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/contract/eth-call/eip1559`, {
            network,
            from: fromAddress,
            to: toAddress,
            gasLimit,
