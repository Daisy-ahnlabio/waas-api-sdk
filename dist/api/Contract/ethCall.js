...
const ethCall = (accessToken, network, isEIP1559, toAddress, data, fromAddress, gasLimit, gasPrice, value, nonce, maxPriorityFeePerGas, maxFeePerGas) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(`${process.env.REACT_APP_WAASURL}/wapi/v2/contract/eth-call`, {
            network,
            isEIP1559,
            from: fromAddress,
            to: toAddress,
