...
var preSign = function (accessToken, network, type, additionalData, uid, wid, sid) {
    if (additionalData === void 0) { additionalData = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var requestData, gasInfo, gasInfo, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    requestData = __assign({ uid: uid, wid: wid, sid: sid, type: type, network: network, from: sid }, additionalData);
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4: return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/sign/pre"), qs_1.default.stringify(requestData), {
                        headers: {
