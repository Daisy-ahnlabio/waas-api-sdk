...
function signTypedData(accessToken, network, type, jsonMessage, uid, wid, sid, pvencstr, encryptDevicePassword) {
    return __awaiter(this, void 0, void 0, function () {
        var channelid, encryptedWid, encryptedPvencstr, encryptedDevicePassword, payload, signResponse, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, axios_1.default.post("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/sign/typed-data"), qs_1.default.stringify(payload), {
                            headers: {
                ...
                case 5:
                    ...
                    if (signResponse.status === 200) {
                        ...
                        return [2 /*return*/, signResponse.data.result];
                    }
                    else {
