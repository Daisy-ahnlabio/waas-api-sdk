...
var getNFTSymbol = function (accessToken, network, contractAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/nft/symbol"), {
                        headers: {
            ...
            case 1:
                ...
                if (response.status === 200) {
                    console.log(chalk_1.default.green("Successfully retrieved NFT symbol:"), chalk_1.default.blue(response.data.result));
...
exports.default = getNFTSymbol;
//# sourceMappingURL=getNFTSymbol.js.map