...
var getNFTBalance = function (accessToken, network, contractAddress, walletAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.REACT_APP_WAASURL, "/wapi/v2/nft/balance"), {
                        headers: {
            ...
            case 1:
                ...
                if (response.status === 200) {
                    console.log(chalk_1.default.green("Successfully retrieved NFT balance:"), chalk_1.default.blue(response.data.result));
...
exports.default = getNFTBalance;
//# sourceMappingURL=getNFTBalance.js.map